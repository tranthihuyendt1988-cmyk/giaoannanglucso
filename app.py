...
<div style='text-align: center; background: linear-gradient(135deg, #004e92 0%, #000428 100%); padding: 20px; border-radius: 10px; color: white; margin-bottom: 20px;'>
    ...
    <p style='margin-top:10px;'>Tác giả: Cô Trần Thị Huyền - PTDTBT TH Du Tiến </p>
</div>
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Trần Thị Huyền - Trường PTDTBT Tiểu học Du Tiến - ĐT: 0832113491 </div>", unsafe_allow_html=True)
